			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Consultar materias</h5>
						...
						<form action="#" class="form-horizontal">
							<div class="modal-body">
								<div class="form-group row">
									...
									<div class="col-lg-9">
										<input type="text" class="form-control" placeholder="Física">
									</div>
								</div>
						...
						<form action="#" class="form-horizontal">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Nombre:</label>
									<div class="col-lg-9">
										<input type="password" class="form-control" placeholder="Algebra">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-lg-3 col-form-label">Especialidad:</label>
									<div class="col-lg-9">
										<input type="password" class="form-control" placeholder="Maestría">
									</div>
								</div>
