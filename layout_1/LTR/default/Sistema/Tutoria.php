					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-closed">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form layouts">
								...
								<!--
								<li class="nav-item"><a href="agregar_materias.php" class="nav-link active">Agregar materias</a></li>
								<li class="nav-item"><a href="agregar_Materias.php" class="nav-link active">Agregar materias</a></li>-->
							</ul>
						</li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Tutorías</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Tutorías</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div align="right"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#agregar" onclick="location='agregar_tutoria.php'">Agregar</button></div>
