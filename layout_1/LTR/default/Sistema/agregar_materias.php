			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Agregar materias</span> </h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Agregar materias</span>
						</div>
							...
							<div class="card-body">
								<form action="#">
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Álgebra Lineal">
										</div>
									</div>
